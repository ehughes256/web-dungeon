...
// Load the modules
const { Scroll, PsionicScroll, SCROLL_MAGIC_ASSIGNMENTS, initializeScrollMagicPhrases } = require('./scrolls.js');
const { Potion, HealthPotion, POTION_COLOR_ASSIGNMENTS, initializePotionColors } = require('./potions.js');
...
Player.identifiedScrollTypes.add('Psionic Scroll');
const { TeleportScroll } = require('./scrolls.js');
