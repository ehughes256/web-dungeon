    ...
    static get itemTypes() {
        if (!this._itemTypes) {
            this._itemTypes = [
                ...
                {class: StrengthPotion, chance: StrengthPotion.dropChance},
                {class: DexterityPotion, chance: DexterityPotion.dropChance},
                {class: IntelligencePotion, chance: IntelligencePotion.dropChance},
                {class: WisdomPotion, chance: WisdomPotion.dropChance},
                {class: ConstitutionPotion, chance: ConstitutionPotion.dropChance},
                {class: CharismaPotion, chance: CharismaPotion.dropChance},
                {class: LuckPotion, chance: LuckPotion.dropChance},
