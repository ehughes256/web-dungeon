...
const { Scroll, PsionicScroll, TeleportScroll, initializeScrollMagicPhrases } = require('./scrolls.js');
const { Potion, HealthPotion, SpeedPotion, initializePotionColors } = require('./potions.js');
