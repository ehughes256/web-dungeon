...
const { Scroll, PsionicScroll, initializeScrollMagicPhrases } = require('../../items/scrolls.js');
const { Potion, HealthPotion, initializePotionColors } = require('../../items/potions.js');
